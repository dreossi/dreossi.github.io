...
A mix of confusion and familiarity surprised me. This looked like an optimization problem where the loss is the objective function to minimize and backpropagation is the [*chain rule*](https://en.wikipedia.org/wiki/Chain_rule), both concepts that I learned early in optimization and analysis classes in college.
I remember thinking, "am I oversimplifying or missing something?"
If not, why the need to coin a new term?

It turns out that backpropagation is the chain rule.<sup><a href="#fn1">1</a></sup> It was surprising to me that an entire thriving domain coined and accepted a new term for something that had existed for more than 300 years.
